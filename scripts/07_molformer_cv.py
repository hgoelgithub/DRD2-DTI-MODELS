...
# Workflow guide:
# Use a frozen MoLFormer to turn SMILES into pooled embeddings, cache them, and train a fresh
# small MLP head per development fold. The encoder is never fine-tuned. Test predictions use
# each fold’s validation-selected head.
