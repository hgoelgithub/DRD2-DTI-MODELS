"""
08 | DRD2: SELFormer Frozen-Embedding Classification

Evaluate SELFIES-based pretrained molecular representations for DRD2 activity prediction.

Method
------
Convert SMILES to SELFIES, extract frozen HUBioDataLab/SELFormer embeddings, and train a fresh
MLP head within each development fold.
...
-------
Saved under results/:
- 08_SELFormer_cv_folds.csv
- 08_SELFormer_summary.csv
- 08_SELFormer_epoch_vs_loss.png

Outcome and Interpretation
--------------------------
Compare validation performance with the SMILES-based pretrained encoders to assess the
representation under this classifier setup. Cached embeddings must be regenerated when
molecules, row order, or encoder settings change.
"""
